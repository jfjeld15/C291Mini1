...
--- Users ---
insert into users values ('u1', 'Maheen Lynn','p1');
insert into users values ('u2', 'Leena Markham','p2');
insert into users values ('u3', 'Branden Escobar','p3');
insert into users values ('u4', 'Digby Tierney','p4');
insert into users values ('u5', 'Harriet Beck','p5');
insert into users values ('u6', 'Aron Gu','p6');
insert into users values ('u7', 'Jeevan Dillard','p7');
insert into users values ('u8', 'Laaibah Cano','p8');
insert into users values ('u9', 'Ameila Pike','p9');
insert into users values ('u10','Davood Rafiei','p10');
insert into users values ('u11', 'Spencer Schimdt','p11');
insert into users values ('u12', 'Ryder Catonio','p12');
insert into users values ('u13', 'Dradelli Guy','p13');
insert into users values ('u14', 'Aron Gu','p14');
insert into users values ('u15', 'Mark Sanchez','p15');
insert into users values ('u16', 'Marion Trap','p16');
insert into users values ('u17', 'Mackenzie Parks','p17');
insert into users values ('u18', 'Daria Blackburn','p18');
insert into users values ('u19', 'Samuel Dixon','p19');
insert into users values ('u20','Hamed Mirzaei','p20');
insert into users values ('u21', 'Amelia Pike','p21');
insert into users values ('u22', 'Quinn Mccartney','p22');
insert into users values ('u23', 'Brenden Akhtar','p23');
insert into users values ('u24', 'Catrina Maxwell','p24');
insert into users values ('u25', 'Darsh Snyder','p25');
insert into users values ('u26', 'Pheobe Shannon','p26');
insert into users values ('u27', 'Judy Walsh','p27');
insert into users values ('u28', 'Bret Bartlett','p28');
insert into users values ('u29', 'Diogo Lowry','p29');
insert into users values ('u30', 'Rudra Duke','p30');
insert into users values ('u31', 'Mike Smith','p31');
insert into users values ('u32', 'Conner Wang','p32');
insert into users values ('u33', 'Saim Hays','p33');
insert into users values ('u34', 'Jeanne Carlson','p34');
insert into users values ('u35', 'John-Paul Whittaker','p35');
insert into users values ('u36', 'Bjorn Partridge','p36');
insert into users values ('u37', 'Dominic Chen','p37');
insert into users values ('u38', 'Aleah Mendoza','p38');
insert into users values ('u39', 'Kiyan Underwood','p39');
insert into users values ('u40', 'Wendy Fernandez','p40');
insert into users values ('u41', 'Shamima Gonzales','p41');
insert into users values ('u42', 'Mike Smith','p42');
...
--- Artists ---
insert into artists values ('a1', 'Lady Gaga', 'United States',random());
insert into artists values ('a2', 'OneRepublic', 'United States',random());
insert into artists values ('a3', 'Imagine Dragons', 'United States',random());
insert into artists values ('a4', 'PSY', 'South Korea',random());
insert into artists values ('a5', 'P!nk', 'American',random());
insert into artists values ('a6', 'Nate Reuss', 'American',random());
insert into artists values ('a7', 'Kelly Clarkson', 'United States',random());
insert into artists values ('a8', 'Janelle MonÃ¡e', 'United States',random());
insert into artists values ('a9', 'Maroon 5', 'United States',random());
insert into artists values ('a10', 'Drake', 'Canada',random());
insert into artists values ('a11', 'Pitbull', 'American',random());
insert into artists values ('a12', 'Sia', 'Australian',random());
insert into artists values ('a13', 'Neon Trees', 'American',random());
insert into artists values ('a14', 'Carly Rae Jepsen', 'Canada',random());
insert into artists values ('a15', 'Calvin Harris', 'Scotland',random());
insert into artists values ('a16', 'Ellie Goulding', 'United Kingdom',random());
insert into artists values ('a17', 'Avicii', 'Swedish',random());
insert into artists values ('a18', 'Sean Paul', 'Jamaica',random());
insert into artists values ('a19', 'David Guetta', 'French',random());
insert into artists values ('a20', 'Bob Ezrin', 'Canadian',random());
insert into artists values ('a21', 'Echosmith', 'American',random());
insert into artists values ('a22', 'The Wanted', 'British',random());
insert into artists values ('a23', 'Selena Gomez', 'United States',random());
insert into artists values ('a24', 'Rixton', 'British',random());
insert into artists values ('a25', 'American Authors', 'American',random());
insert into artists values ('a26', 'Cobra Starship', 'American',random());
insert into artists values ('a27', 'Captial Cities', 'American',random());
insert into artists values ('a28', 'WALK THE MOON', 'United States',random());
insert into artists values ('a29', 'Jason Derulo', 'American',random());
insert into artists values ('a30', 'Taio Cruz', 'English',random());
insert into artists values ('a31', 'The Script', 'Ireland',random());
insert into artists values ('a32', 'Jennifer Lopez', 'American',random());
insert into artists values ('a33', 'Shakira', 'Colombia',random());
insert into artists values ('a34', 'The Weeknd', 'Canada',random());
insert into artists values ('a35', 'Celine Dion', 'Canada',random());
insert into artists values ('a36', 'Avril Lavigne', 'Canadian',random());
insert into artists values ('a37', 'Flo Rida', 'American',random());
insert into artists values ('a38', 'Spice Girls', 'British',random());
insert into artists values ('a39', 'Ed Sheeran', 'England',random());
